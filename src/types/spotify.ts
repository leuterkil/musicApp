...
// the available_markets are missing. Therefore it is marked as optional in this source code.
    ...
    export interface AudioAnalysisIntervalObject {
        start: number;
        duration: number;
        confidence: number;
    }
     ...
     */
    export interface RecommendationTrackObject extends Omit<TrackObjectFull, "album"> {
     ...
     */
    export interface RecommendationAlbumObject extends Omit<AlbumObjectSimplified, "album_type"> {
        /**
         * The type of the album: one of “ALBUM”, “SINGLE”, or “COMPILATION”.
